...
import { Checkbox, DateTime, RadioGroup, Range, Select, TextInput, Toggle } from 'ionic-angular'
import {
...
export class DynamicFormIonicComponent extends DynamicFormControlComponent implements OnChanges {
  ...
  constructor(changeDetectorRef: ChangeDetectorRef, protected validationService: DynamicFormValidationService) {
