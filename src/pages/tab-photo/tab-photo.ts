...
/**
 * Generated class for the TabPhotoPage page.
 *
...
@IonicPage()
@Component({
    selector: 'page-tab-photo',
    templateUrl: 'tab-photo.html',
})
export class TabPhotoPage {
    eventName: string = 'homePhoto';
    ...
    constructor(
        ...
        // Google Analytics
        this.analytics.view('TabPhotoHomePage');
        // this.eventName = 'home';
        ...
        this.events.subscribe('tabTimelineHome', () => {
            //alert("Hello")
