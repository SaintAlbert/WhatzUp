...
@IonicPage()
@Component({
  selector: 'page-upcoming-comment-modal',
  templateUrl: 'upcoming-comment-modal.html',
})
export class UpcomingCommentModalPage {
    ...
    constructor(private navparams: NavParams,
        ...
        private provider: UpcomingCommentProvider,
        private util: IonicUtilProvider,
        private Upcoming: UpcomingProvider,
        private analytics: AnalyticsProvider) {
        // Google Analytics
        this.analytics.view('UpcomingCommentModalPage');
    ...
    onGallery(galleryId: string) {
        this.loading = true;
        this.Upcoming.getParse(galleryId).then(gallery => {
            //this.form.gallery = gallery;
            this.form.upcoming = gallery;
